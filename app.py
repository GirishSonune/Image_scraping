                ...
                try:
                    ...
                    for index,image_tag in enumerate(image_tags):
                                ...
                                with open(os.path.join(save_directory, f"{query}_{image_tags.index(image_tag)}.jpg"), "wb") as f:
                                    f.write(image_data)
                #     client = pymongo.MongoClient("<db_username>:<db_password>@cluster0.ln0bt5m.mongodb.net/?retryWrites=true&w=majority")
                    client = pymongo.MongoClient("mongodb+srv://<db_username>:<db_password>@cluster0.4r8w4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
